...
export function ScrollNav() {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-center gap-3 px-4 md:px-6 lg:px-10 h-14 md:h-16">
        {/* Hamburger */}
        <Sheet>
        ...
        {/* Compact search */}
        <form onSubmit={submitSearch} role="search" className="w-full max-w-sm md:max-w-md">
          <label className="relative flex items-center w-full">
            ...
            <input
              ...
              placeholder="Buscar..."
              aria-label="Buscar"
              className="h-9 md:h-10 w-full rounded-full border border-border bg-card/60 pl-11 pr-4 text-sm placeholder:text-muted-foreground focus:bg-card focus:border-primary/60 focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all"
            />
          </label>
        </form>
        ...
        <Button
          asChild
          variant="secondary"
          className="hidden sm:inline-flex bg-background border border-border p-0 pr-1 rounded-full hover:bg-muted/50 transition-all duration-300 group h-9 shrink-0"
        >
          <Link href="/login">
